...
#include "/home/codeleaded/System/Static/Library/IntraASMDefines.h"
    ...
    TypeMap_PushContained(&s->types,funcs,
        Type_New("bool",sizeof(Boolean),OperatorInterationMap_Make((OperatorInterater[]){
            OperatorInterater_Make((CStr[]){ NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_INTRAASM_LOT,  (Token(*)(void*,Token*,Vector*))Boolean_Handler_Not),
            ...
            OperatorInterater_Make((CStr[]){ "bool",NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_INTRAASM_ASS,  (Token(*)(void*,Token*,Vector*))Boolean_Boolean_Handler_Ass),
                OperatorDefiner_New(TOKEN_INTRAASM_EQU,  (Token(*)(void*,Token*,Vector*))Boolean_Boolean_Handler_Equ),
                OperatorDefiner_New(TOKEN_INTRAASM_LND,  (Token(*)(void*,Token*,Vector*))Boolean_Boolean_Handler_And),
                OperatorDefiner_New(TOKEN_INTRAASM_LOR,  (Token(*)(void*,Token*,Vector*))Boolean_Boolean_Handler_Or),
                OPERATORDEFINER_END
            })),
