    ...
    TypeMap_PushContained(&s->types,funcs,
        Type_New("str",8,OperatorInterationMap_Make((OperatorInterater[]){
            ...
            OperatorInterater_Make((CStr[]){ "str",NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_INTRAASM_ASS,(Token(*)(void*,Token*,Vector*))Str_Str_Handler_Ass),
                OperatorDefiner_New(TOKEN_INTRAASM_ADD,(Token(*)(void*,Token*,Vector*))Str_Str_Handler_Add),
                OperatorDefiner_New(TOKEN_INTRAASM_EQU,(Token(*)(void*,Token*,Vector*))Str_Str_Handler_Equ),
                OPERATORDEFINER_END
            })),
